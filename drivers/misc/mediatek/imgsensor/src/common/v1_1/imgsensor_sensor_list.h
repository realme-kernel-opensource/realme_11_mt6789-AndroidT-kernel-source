...
//doki
UINT32 S5KJN1_MIPI_RAW_DOKI_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 OV16A1Q_MIPI_RAW_DOKI_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 OV02B1B_MIPI_MONO_DOKI_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 SC201CS_MIPI_MONO_DOKI_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 S5KHM6SP_MIPI_RAW_DOKI_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 OV16A1Q_MIPI_RAW_ADOKI_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 OV02B1B_MIPI_MONO_ADOKI_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 SC201CS_MIPI_MONO_ADOKI_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
//changzheng
...
UINT32 SC201CS_MIPI_RAW_CHANGZHENG_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 GC02M1_MIPI_RAW_CHANGZHENG_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc);
