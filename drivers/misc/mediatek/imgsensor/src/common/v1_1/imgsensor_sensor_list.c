...
{S5KJN1_SENSOR_ID_DOKI, SENSOR_DRVNAME_S5KJN1_MIPI_RAW_DOKI, S5KJN1_MIPI_RAW_DOKI_SensorInit},
#endif
#if defined(S5KHM6SP_MIPI_RAW_DOKI)
{S5KHM6SP_SENSOR_ID_DOKI, SENSOR_DRVNAME_S5KHM6SP_MIPI_RAW_DOKI, S5KHM6SP_MIPI_RAW_DOKI_SensorInit},
#endif
#if defined(OV16A1Q_MIPI_RAW_DOKI)
{OV16A1Q_SENSOR_ID_DOKI, SENSOR_DRVNAME_OV16A1Q_MIPI_RAW_DOKI, OV16A1Q_MIPI_RAW_DOKI_SensorInit},
#endif
#if defined(OV02B1B_MIPI_MONO_DOKI)
{OV02B1B_SENSOR_ID_DOKI, SENSOR_DRVNAME_OV02B1B_MIPI_MONO_DOKI, OV02B1B_MIPI_MONO_DOKI_SensorInit},
#endif
#if defined(SC201CS_MIPI_MONO_DOKI)
{SC201CS_SENSOR_ID_DOKI, SENSOR_DRVNAME_SC201CS_MIPI_MONO_DOKI, SC201CS_MIPI_MONO_DOKI_SensorInit},
#endif
#if defined(OV16A1Q_MIPI_RAW_ADOKI)
{OV16A1Q_SENSOR_ID_ADOKI, SENSOR_DRVNAME_OV16A1Q_MIPI_RAW_ADOKI, OV16A1Q_MIPI_RAW_ADOKI_SensorInit},
#endif
#if defined(OV02B1B_MIPI_MONO_ADOKI)
{OV02B1B_SENSOR_ID_ADOKI, SENSOR_DRVNAME_OV02B1B_MIPI_MONO_ADOKI, OV02B1B_MIPI_MONO_ADOKI_SensorInit},
#endif
#if defined(SC201CS_MIPI_MONO_ADOKI)
{SC201CS_SENSOR_ID_ADOKI, SENSOR_DRVNAME_SC201CS_MIPI_MONO_ADOKI, SC201CS_MIPI_MONO_ADOKI_SensorInit},
#endif
//changzheng
#if defined(OV32C_MIPI_RAW_CHANGZHENG)
{OV32C_SENSOR_ID_CHANGZHENG, SENSOR_DRVNAME_OV32C_MIPI_RAW_CHANGZHENG,
        OV32C_MIPI_RAW_CHANGZHENG_SensorInit},
#endif
#if defined(OVA0B4_MIPI_RAW_CHANGZHENG)
{OVA0B4_SENSOR_ID_CHANGZHENG, SENSOR_DRVNAME_OVA0B4_MIPI_RAW_CHANGZHENG,
        OVA0B4_MIPI_RAW_CHANGZHENG_SensorInit},
#endif
#if defined(S5KHM6S_MIPI_RAW_CHANGZHENG)
{S5KHM6S_SENSOR_ID_CHANGZHENG, SENSOR_DRVNAME_S5KHM6S_MIPI_RAW_CHANGZHENG,
        S5KHM6S_MIPI_RAW_CHANGZHENG_SensorInit},
#endif
#if defined(OV02B1B_MIPI_MONO_CHANGZHENG)
{OV02B1B_SENSOR_ID_CHANGZHENG, SENSOR_DRVNAME_OV02B1B_MIPI_MONO_CHANGZHENG,
        OV02B1B_MIPI_MONO_CHANGZHENG_SensorInit},
#endif
#if defined(SC201CS_MIPI_RAW_CHANGZHENG)
{SC201CS_SENSOR_ID_CHANGZHENG, SENSOR_DRVNAME_SC201CS_MIPI_RAW_CHANGZHENG,
        SC201CS_MIPI_RAW_CHANGZHENG_SensorInit},
#endif
#if defined(GC02M1_MIPI_RAW_CHANGZHENG)
{GC02M1_SENSOR_ID_CHANGZHENG, SENSOR_DRVNAME_GC02M1_MIPI_RAW_CHANGZHENG,
        GC02M1_MIPI_RAW_CHANGZHENG_SensorInit},
#endif
